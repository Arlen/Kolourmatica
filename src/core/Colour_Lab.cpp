...
auto km::convert_to_Lab(const XYZ& col, const Illuminant& rw) -> Lab
{
...
auto km::convert_to_Lab(const xyY& col, const Illuminant& rw) -> Lab
{
    return convert_to_Lab(convert_to_XYZ(col), rw);
}

auto km::convert_to_Lab(const LCHab& col) -> Lab
{
    Lab result;
...
auto km::convert_to_Lab(const Luv& col, const Illuminant& rw) -> Lab
{
    return convert_to_Lab(convert_to_XYZ(col), rw);
}

auto km::convert_to_Lab(const LCHuv& col, const Illuminant& rw) -> Lab
{
    return convert_to_Lab(convert_to_XYZ(col), rw);
}

auto km::convert_to_Lab(const RGB& col, const Illuminant& rw) -> Lab
{
    return convert_to_Lab(convert_to_XYZ(col), rw);
}