...
auto km::convert_to_XYZ(const Lab &col) -> XYZ
{
...
auto km::convert_to_XYZ(const LCHab& col) -> XYZ
{
    return convert_to_XYZ(convert_to_Lab(col));
}

auto km::convert_to_XYZ(const Luv& col) -> XYZ
{
...
auto km::convert_to_XYZ(const LCHuv& col) -> XYZ
{
    return convert_to_XYZ(convert_to_Luv(col));
}

auto km::convert_to_XYZ(const RGB& col) -> XYZ
{
