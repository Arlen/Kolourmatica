...
#ifndef SPACE_ECIRGB_HPP
#define SPACE_ECIRGB_HPP
...
template <class Real>
class Space_ECIRGB : public Space_LinearRGB<Real>{
...
public:
  Space_ECIRGB(Real r = 1, Real g = 1, Real b = 1) :
  ...
  Space_ECIRGB(const Vector3& tri) :
    Space_LinearRGB<Real>(RefWhite(D50()),
			  Real(1.8),
			  xyY(0.67, 0.33, 1.0),
			  xyY(0.21, 0.71, 1.0),
  ...
  Space_ECIRGB(const LinearRGB& other) :
